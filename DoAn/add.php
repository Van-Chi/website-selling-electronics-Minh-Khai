...
switch ($hd) {
	...
	case 'themsp':
		...
		$sql = "INSERT INTO sanpham VALUES ('{$masanpham}','$tensanpham','$chitiet','$congsuat','$noisanxuat','$thoigianbaohanh','$congnghe','$congdung','$kichthuoc','$cannang','$soluonghang','$donvitinh','$dongia','$madanhmuc','$manhacungcap')";
		$result = $conn->query($sql);
